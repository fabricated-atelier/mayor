...
public class MayorBlockEntities {
    ...
    public static final ScreenHandlerType<DeskBlockScreenHandler> DESK_SCREEN_HANDLER = new ExtendedScreenHandlerType<>(
            (syncId, playerInventory, data) -> new DeskBlockScreenHandler(syncId, data), DeskPacket.PACKET_CODEC);
