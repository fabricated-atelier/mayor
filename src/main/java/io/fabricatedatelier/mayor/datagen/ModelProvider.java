        ...
        return BlockStateVariantMap.create(MayorProperties.SHAPE, MayorProperties.POSITION, MayorProperties.SIDE)
                .register((part, position, side) -> switch (part) {
                            ...
                            case TWO_WALLS_END -> {
                                ...
                                if (position.equals(LumberStorageBlock.VerticalPosition.BOTTOM)) model += "bottom";
                                else model += "top";
                            ...
                            case ONE_WALL_END -> {
                                ...
                                if (side.equals(LumberStorageBlock.Side.RIGHT)) model += "_right";
                                else model += "_left";

                                if (position.equals(LumberStorageBlock.VerticalPosition.TOP)) model += "_top";
